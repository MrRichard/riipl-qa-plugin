...
function ClassMapping(){
	this.newInstance=function(name) {
	    ...
	    if (prefix === 'riiplqa') {
		if(name.includes("NormCat12PCASL8")){
			if(window.riiplqa_NormCat12PCASL8Data==undefined) dynamicJSLoad('riiplqa_NormCat12PCASL8Data','generated/riiplqa_NormCat12PCASL8Data.js');
			return new riiplqa_NormCat12PCASL8Data();
		}

		if(name.includes("NormCat12PCASL")){
		if(window.riiplqa_NormCat12PCASLData==undefined) dynamicJSLoad('riiplqa_NormCat12PCASLData','generated/riiplqa_NormCat12PCASLData.js');
		return new riiplqa_NormCat12PCASLData();
		}

		if(name.includes("NormCat12NODDI")){
			if(window.riiplqa_NormCat12NODDIData==undefined) dynamicJSLoad('riiplqa_NormCat12NODDIData','generated/riiplqa_NormCat12NODDIData.js');
			return new riiplqa_NormCat12NODDIData();
		}

		if(name.includes("SegCat12")){
			if(window.riiplqa_SegCat12Data==undefined) dynamicJSLoad('riiplqa_SegCat12Data','generated/riiplqa_SegCat12Data.js');
			return new riiplqa_SegCat12Data();
		}

		if(name.includes("NormCat12DTI")){
			if(window.riiplqa_NormCat12DTIData==undefined) dynamicJSLoad('riiplqa_NormCat12DTIData','generated/riiplqa_NormCat12DTIData.js');
			return new riiplqa_NormCat12DTIData();
		}

		if(name.includes("NormCat12PETPVC")){
			if(window.riiplqa_NormCat12PETPVCData==undefined) dynamicJSLoad('riiplqa_NormCat12PETPVCData','generated/riiplqa_NormCat12PETPVCData.js');
			return new riiplqa_NormCat12PETPVCData();
		}
	    }
        }
