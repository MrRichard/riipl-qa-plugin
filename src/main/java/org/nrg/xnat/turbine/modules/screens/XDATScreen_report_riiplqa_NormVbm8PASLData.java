 ...
 *
 */
public class XDATScreen_report_riiplqa_NormVbm8PASLData extends SecureReport
{
	...
	public void finalProcessing(RunData data, Context context)
	{
		try {
			...
			context.put("om",om);
			System.out.println("Loaded om object (org.nrg.xdat.om.Normvbm8pasldata) as context parameter 'om'.");
			context.put("mr",mr);
