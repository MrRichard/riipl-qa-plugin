 ...
 */
public class XDATScreen_edit_riiplqa_NormVbm8LST8Data extends org.nrg.xnat.turbine.modules.screens.EditImageAssessorScreen {
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(XDATScreen_edit_riiplqa_NormVbm8LST8Data.class);
	/* (non-Javadoc)
	...
	{
		logger.debug("XDATScreen_edit_riiplqa_NormVbm8LST8Data::finalProcessing");
		org.nrg.xdat.om.RiiplqaNormvbm8lst8data om = new org.nrg.xdat.om.RiiplqaNormvbm8lst8data(item);
...
//		imageFilters.add(new WildcardFileFilter(new String[] {"wr*P?????_CBF.nii*","wr*._CBF.nii*"}));
		...
		RiiplVbm8Utils.normalizationQCedit(mr, data, item, this.getElementName(),"NormVbm8LST8", "tlv_all.csv", imageFilters,false);
	}
}
