 ...
 *
 */
public class XDATScreen_report_riiplqa_NormVbm8PCASLData extends SecureReport
{
	...
	public void finalProcessing(RunData data, Context context)
	{
		try
		{
			...
			context.put("om",om);
			System.out.println("Loaded om object (org.nrg.xdat.om.RiiplNormvbm8pcasldata) as context parameter 'om'.");
			context.put("mr",mr);
