 ...
 */
public class Upload_riiplqa_NormVbm8vPCASLData extends org.nrg.xnat.turbine.modules.screens.EditImageAssessorScreen {
	static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Upload_riiplqa_NormVbm8vPCASLData.class);
	/* (non-Javadoc)
	...
	{
		logger.debug("Upload_riiplqa_NormVbm8vPCASLData::finalProcessing");
		org.nrg.xdat.om.RiiplNormvbm8vpcasldata om = new org.nrg.xdat.om.RiiplNormvbm8vpcasldata(item);
		...
		RiiplVbm8Utils.normalizationQC(mr, data, item, this.getElementName(),"NormVbm8vPCASL", "PCASLv_segmentation_report.csv", imageFilters,true);
	}
}
